...
('FAQ_20230216_3','배송시간이 얼마나 걸릴까요?','평균 며칠정도 걸리나 궁금합니다','2022-08-10 03:50:14','천혜향',NULL,'네 고객님 보통 영업일 3일이내에 도착합니다. 자세한 사항은 저희 홈페이지를 참고해주세요','user1','BOARD_FAQ', 'FAQ_SHIPPING'),
('FAQ_20230216_4','해외배송도 가능한가요?','일본이나 중국도 배송이 가능할까요?','2022-08-10 04:20:54','한라봉',NULL,'네 고객님 현재는 저희가 해외배송은 진행하고 있지 않습니다','user2','BOARD_FAQ', 'FAQ_SHIPPING'),
('FAQ_20230216_5','배송할 곳 주소를 확인하고 싶어요','지도로 확인가능한 곳 있나요?','2022-08-13 21:36:59','천혜향',NULL,'네 고객님 저희 화면 상단 점포찾기 메뉴를 이용하시면 지도 서비스 이용 가능합니다.','user1','BOARD_FAQ', 'FAQ_MAP'),
('FAQ_20230216_6','지도가 잘못된 거 같아요','주소와 지도가 다르게 나올수도 있나요?','2022-08-23 23:57:10','한라봉',NULL,'지도 서비스는 외부에서 가져와 사용하는 것이기에 저희 측 오류는 아닙니다. 주소를 정확하게 입력하셨는지 확인해 보시겠어요?','user2','BOARD_FAQ', 'FAQ_MAP'),
...
('FAQ_20230216_8','물건이 사라진거 같아요','배송완료라고 나오는데 물건이 없습니다','2022-11-23 23:40:26','한라봉',NULL,'네 고객님 일단 운송장번호를 남겨주시면 저희가 배송기사님측에 연락해보겠습니다','user2','BOARD_FAQ', 'FAQ_ACCIDENT')
;
