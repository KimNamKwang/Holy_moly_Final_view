...
VALUES
('user1','천혜향','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','abc@naver.com','1995-03-21','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01012345678',
'Y', 'GRADE_F','AUTH_U'),
('user2','한라봉','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','abc@naver.com','2000-08-15','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01023456789',
'Y','GRADE_F','AUTH_U'),
('user3','금귤','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','abc@naver.com','1992-07-07','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01023456789',
'N(NULL이면 N으로 들어가게 하던지 체크가 안되면 으로 들어가게 하던지.)','GRADE_F','AUTH_U'),
('user4','안성국','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','ask123@naver.com','2005-02-11','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01023256789',
'Y','GRADE_PL','AUTH_U'),
('user5','천호연','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','choyeon@naver.com','1992-01-01','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01021456789',
'Y','GRADE_V','AUTH_U'),
('user6','채치수','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','sizechae@naver.com','1990-10-07','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'0103556789',
NULL,'GRADE_PU','AUTH_U'),
('user7','강백호','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','power@naver.com','1992-07-25','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01023643789',
'Y','GRADE_V','AUTH_U'),
('user8','이재현','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','jhlee@naver.com','1992-02-08','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01023956789',
'N(NULL이면 N으로 들어가게 하던지 체크가 안되면 으로 들어가게 하던지.)','GRADE_F','AUTH_U'),
('user9','김남광','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','kjf@naver.com','1999-09-01','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01023456569',
NULL,'GRADE_PU','AUTH_U'),
('user10','김석진','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','sjk@naver.com','1999-10-17','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01053456789',
'Y','GRADE_F','AUTH_U'),
('user11','안지영','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','elle@naver.com','2019-07-07','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01090456789',
'Y','GRADE_F','AUTH_U'),
('user12','왕지영','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','KINGelle@naver.com','2019-07-07','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01185889955',
'Y','GRADE_V','AUTH_U'),
('admin1','관리자','$2a$10$lNoaDTHR5.LvYz7t1k6rGu4KUVE7SNC7pfgMDxzdqjIXfB3bke8gq','abc@naver.com','1983-06-30','01684','서울시 강남구 테헤란로 84','101호','',sysdate(),'01030067890',
...
(COMMONBOARD_UID, TITLE, CONTENT, DATE_CREATED, WRITER, VIEWS, REPLY_FOR_FAQ, USER_UID, BOARD_UID) 
VALUES
('EVT_20230216_1','김석진 데이터베이스 6행시 성공 기념 이벤트','이번 이벤트는 로지텍 마우스 추첨행사입니다',sysdate(),'관리자',123,NULL,'admin1','BOARD_EVENT'),
('EVT_20230216_2','김석진 로지텍 마우스 당첨 기념 이벤트','로지텍 마우스에 당첨되신 분에 한해 로지텍 햄스터를 드립니다.',sysdate(),'관리자',100,NULL,'admin1','BOARD_EVENT'),
('EVT_20230216_3','왕석진 로지착 청설모 당첨 기념 이벤트','로지텍 마우스에 당첨되신 분에 한해 로지텍 햄스터를 드립니다.',sysdate(),'관리자',100,NULL,'admin1','BOARD_EVENT'),
('EVT_20230216_4','진석기 햄스터 마우스 당첨 기념 이벤트','로지텍 마우스에 당첨되신 분에 한해 로지텍 햄스터를 드립니다.',sysdate(),'관리자',100,NULL,'admin1','BOARD_EVENT'),
('EVT_20230216_5','김진영 참외 당첨 기념 이벤트','로지텍 마우스에 당첨되신 분에 한해 로지텍 햄스터를 드립니다.',sysdate(),'관리자',100,NULL,'admin1','BOARD_EVENT'),
('EVT_20230216_6','김준진 수박 당첨 기념 이벤트','로지텍 마우스에 당첨되신 분에 한해 로지텍 햄스터를 드립니다.',sysdate(),'관리자',100,NULL,'admin1','BOARD_EVENT'),
('NOT_20230216_1','3월 배송지연 안내','2023년 3월 1일부터 12일까지 배송이 지연됩니다.',sysdate(),'관리자',15,NULL,'admin1','BOARD_NOTICE'),
('NOT_20230216_2','배송비 인상 안내','2023년 3월부터 배송비가 인상됩니다.',sysdate(),'관리자',76,NULL,'admin1','BOARD_NOTICE'),
('NOT_20230221_1','한파로 인한 배송지연 안내','최근 한파로 인해 도로사정이 좋지 않아 배송이 지연됩니다.',sysdate(),'관리자',9,NULL,'admin1','BOARD_NOTICE'),
('NOT_20230221_2','악성 사용자 제재','최근 DDOS등을 이용해 서버를 공격하는 악성사용자들을 제재할 예정입니다.',sysdate(),'관리자',31,NULL,'admin1','BOARD_NOTICE'),
('NOT_20230221_3','홀리몰리 포스트를 사랑해주시는 고객님들께','안녕하세요 고객님! 저희 홀리몰리 포스트를 이용해주셔서 감사드립니다..람쥐.',sysdate(),'관리자',571,NULL,'admin1','BOARD_NOTICE'),
('NOT_20230221_4','일부 지역 배송불가 안내','폭설로 인해 제주.산간 및 도서지역은 현재 배송이 불가능합니다.',sysdate(),'관리자',152,NULL,'admin1','BOARD_NOTICE'),
('FAQ_20230216_1','어제 배송했는데 언제 도착할까요?','어제 발송했습니다','2023-01-05','천혜향',NULL,'네 고객님 보통 평일 오후 5시 이전에 발송하신 물건은..','user1','BOARD_FAQ'),
('FAQ_20230216_2','접수를 취소하고 싶어요','접수를 취소하고 싶은데 어디서 해야하나요','2023-02-11','한라봉',NULL,'저희 예약 접수 화면을 보시면 예약확인 및 취소란이 있습니다.','user2','BOARD_FAQ'),
('FAQ_20230216_3','FAQ 배송문의1','내용부분',sysdate(),'천혜향',NULL,'답변입니다','user1','BOARD_FAQ'),
('FAQ_20230216_4','FAQ 배송문의2','내용부분',sysdate(),'한라봉',NULL,'답변란','user2','BOARD_FAQ'),
('FAQ_20230216_5','FAQ 지도문의1','내용부분',sysdate(),'천혜향',NULL,'답변란입니다','user1','BOARD_FAQ'),
('FAQ_20230216_6','FAQ 지도문의2','내용부분',sysdate(),'한라봉',NULL,'답변입니다','user2','BOARD_FAQ'),
('FAQ_20230216_7','물품이 파손되었을때는 어떻게 하나요','배송을 받아보니 물건이 파손되어있습니다.',sysdate(),'천혜향',NULL,'물품이 파손되었을시에는 먼저 저희 고객센터 1577-1122로 전화 혹은..','user1','BOARD_FAQ'),
('FAQ_20230216_8','FAQ 사고문의2','내용부분',sysdate(),'한라봉',NULL,'답변입니다','user2','BOARD_FAQ')
;
...
'02422','서울시 서초구 서초대로14','101동 304호','서초동',50000,25000,1234,'2023-02-19', '2023-01-29 14:45:56','SHIP_GEN','REQ_04','item_m_02')
;
...
('SHIP_PROG_STAT_6','IN_PROGRESS','배송중',sysdate(),'TRK_20230217_1'),
